...
def fetch_config(task: Task, remote_file="cf3:/config.cfg", local_dir="backups") -> Result:
    ...
    try:
        ...
        ssh.connect(task.host.hostname, username=task.host.username, password=task.host.password)
